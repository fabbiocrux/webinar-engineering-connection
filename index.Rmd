...
subtitle: ".center[<img src='Figures/Logo-ec.png' width='auto' height='100px'>]"
...
.center[![](Figures/Fabio.png)]

.center[![](https://erpi.univ-lorraine.fr/assets/images/logo-ERPI.svg)]
...
-  The Quintuple Helix Model demonstrates that an investment in knowledge and a
promotion of knowledge-production brings into play new and crucial impulses for innovation, know-how and the advancement of society. 
]
...
.pull-left[![:scale 100%](Figures/quactus.png)
...
class: middle, left
background-image: url(Figures/Climatelabs.png)
...
.pull-left[
![:scale 70%](Figures/Smagrinet.png) 
https://www.smagrinet.eu/

![](Figures/digiterri.png)
https://digiterri.eu/
